...
def question_console():
    """
    fonction permettant de selectionner une question puis d'en afficher la réponse
    affiche les questions, demande à l'utilisateur de choisir l'index d'une question, affiche une réponse
    """
